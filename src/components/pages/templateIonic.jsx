            ...
            return (
                <div className="templates" id="mobile-view" style={{ marginBottom: '1em' }}>
                    <div className="row template_heading">
                        ...
                        <div className="col l8" style={{ marginLeft: '1em', paddingTop: '1.5em' }}>
                    ...
                    <div style={{ padding: '2em 1em 1em 1em', marginTop: '-1em' }}>
